...
<script>
    !function(e,t,a) {
        ...
        n.async=!0,n.defer=!0, n.type="text/javascript",n.src=t+"/static/js/chat_widget.js?config="+JSON.stringify(a),c.appendChild(n)}(document,"https://app.engati.com",{bot_key:"ec71aab13bb74015",welcome_msg:true,branding_key:"default",server:"https://app.engati.com",e:"p" });
</script>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							African - American Delicacies served in style and Sizzles.
						</p>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
                            Quelish is a different kind of architecture practice. Founded by Queen Mog in 1991, we’re an employee-owned firm pursuing a democratic design process that values everyone’s input.
                        </p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="./Design/images/restaurant-logo.png" alt="Restaurant Logo" style="margin-bottom: 20px;">
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 11:30am - 20:08pm</li>
                            <li>Monday - Friday 11:30am - 20:08pm</li>
                            <li>Monday - Friday 11:30am - 20:08pm</li>
                            <li>Monday - Friday 11:30am - 20:08pm</li>
                        </ul>
